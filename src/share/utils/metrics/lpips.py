...
class LearnedPerceptualImagePatchSimilarityMin(Metric):
...
class LearnedPerceptualImagePatchSimilarityAvg(Metric):
    """The Learned Perceptual Image Patch Similarity (`LPIPS_`) calculates perceptual similarity between two images.
